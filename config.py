...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b><blockquote>ᴘᴏᴡᴇʀᴇᴅ ʙʏ - [ʀᴏɴɪɴ ᴀɴɪᴍᴇ](https://t.me/RoninANime)</blockquote></b>") #set your Custom Caption here, Keep None for Disable Custom Caption
